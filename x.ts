...
import { RAMY_EXCHANGE, WORKING_EXCHANGE, RAMY_QUEUE, INDEX_EXCHANGE, DIASTY_QUEUE, BEBO_QUEUE, BEHEIRY_QUEUE, KAREEM_QUEUE, SHABANA_QUEUE, PROGRAMMING_EXCHANGE, WORKING_QUEUE, WORKING_DLX, DEAD_QUEUE, TTL_EXCHANGE } from "./constants";
